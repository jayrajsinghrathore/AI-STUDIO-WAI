            ...
            {generations.length === 0 ? (
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {generations.map((gen) => {
                    const imageUrl = Array.isArray(gen.image_urls) ? gen.image_urls[0] : gen.image_urls
                    return (
                      <div
                        key={gen.id}
...
//             data.map((item: any) => ({
//               id: item.id,
//               imageUrl: Array.isArray(item.image_urls) ? item.image_urls[0] : item.image_urls || "/placeholder.svg",
